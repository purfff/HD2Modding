...
return function(make_api, c)
    ...
    local damage_old, damage_new = raw('0300000003000000'), raw('2c0100002c010000')
    ...
    local function apply(s)
        ...
        log('APPLIED variant=' .. c.variant .. ' Cremator_effect=' .. (swap_effect and 'long_range_experimental' or 'original')
            .. ' damage_17=' .. (boost_damage and '300/300_shared_with_sentry_and_lumberer' or '3/3_unchanged')
